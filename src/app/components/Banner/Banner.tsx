  ...
  return (
    <div className="relative w-full">
      ...
      <div className="container mx-auto">
        {/* Hero Content */}
        <div className="absolute top-1/4 left-6 md:left-12 text-white max-w-sm md:max-w-2xl z-50">
          ...
          <p className="mt-4 text-sm md:text-lg leading-relaxed">
            ...
            surgical techniques, our highly-skilled team offers early diagnosis
            and sophisticated treatment options.
          </p>
        ...
        <motion.div
          ...
          className="hidden sm:block absolute top-[700px] md:top-1/3 md:right-12 transform -translate-y-1/2 md:translate-y-0 bg-white shadow-lg rounded-lg p-4 md:p-6 w-full md:w-[400px] z-50"
        >
