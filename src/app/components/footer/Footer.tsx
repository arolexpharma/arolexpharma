      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 text-gray-300">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-gray-300 mb-4 md:pr-20 lg:pr-60 leading-6">
            Arolex Pharmaceuticals is a trusted partner in contract-based
            manufacturing, marketing, and supplying of high-quality
            pharmaceutical products. With a commitment to innovation and
            excellence, we deliver reliable healthcare solutions tailored to
            meet the needs of our global clients.
          </p>
        </div>
